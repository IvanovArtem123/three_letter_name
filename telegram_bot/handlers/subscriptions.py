...
from texts.subscription import (TEXT_NEW_SUB, TEXT_NEW_SUB_TRIAL, TEXT_PAY_SUB,
                                build_trial_activate_sub,
                                build_manage_sub_text)

from keyboards.default import kb_cancel
from keyboards.subscription import (manage_new_sub_keyboard,
                                    manage_new_sub_trial_keyboard,
                                    new_sub_keyboard)
...
async def cd_pa_sub(callback: CallbackQuery):
    await callback.answer()
    await callback.message.answer(TEXT_PAY_SUB,
